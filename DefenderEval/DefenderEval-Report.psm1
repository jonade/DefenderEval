...
.PARAMETER NoRating
    Prevent the rating toast from being included in the output report.
     ...
     <head>
      ...
      <body>
        <div class='container my-5'>"
            if ($NoRating -eq $false) {
            $output += "<div class='toast-container position-fixed top-0 end-0 p-3'>
